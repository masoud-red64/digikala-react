  ...
  return (
    <div className="not-empty-cart">
            ...
            <div className="swiper-slide">
              <div className="same-product-for-buy__wrapper">
                <a href="#" className="same-product-for-buy__content">
                  ...
                  <div className="same-product-for-buy__content-finish">
                    <div className="same-product-for-buy__content-finish-progress">
                      <div
                        className="same-product-for-buy__content-finish-progress-bar"
                        style={{ width: "8.32292%" }}
                      ></div>
                    </div>
                    <div className="same-product-for-buy__content-finish-sale">
                      <p className="same-product-for-buy__content-finish-sale-text">
                        <span>۲۰%</span> فروش رفته
                      </p>
                      <p className="same-product-for-buy__content-finish-sale-time timer">
                        ۲۲:۰۰:۰۹
                      </p>
                    </div>
                  </div>
                </a>
                <button className="same-product-for-buy__content-add-to-cart-btn">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 24 24"
                    style={{
            ...
            <div className="swiper-slide">
              <div className="same-product-for-buy__wrapper">
                <a href="#" className="same-product-for-buy__content">
                  ...
                  <img
                    src="./images/cart-page/product3.webp"
                    alt=""
                    className="same-product-for-buy__content-product-img"
                  />
                  <p className="same-product-for-buy__content-desc"></p>
                  <p className="fs-6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
            ...
            <div className="swiper-slide">
              <div className="same-product-for-buy__wrapper">
                <a href="#" className="same-product-for-buy__content">
                  ...
                  <img
                    src="./images/cart-page/product4.webp"
                    alt=""
                    className="same-product-for-buy__content-product-img"
                  />
                  <p className="same-product-for-buy__content-desc">
                    مایع لباسشویی پرسیل مدل یونیورسال وزن 2.7 کیلوگرم
                  </p>
                  <p className="fs-6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      style={{ width: "18px", height: "18px", fill: "#6bb927" }}
                    >
                      <path
                        fillRule="evenodd"
            ...
            <div className="swiper-slide">
              <div className="same-product-for-buy__wrapper">
                <a href="#" className="same-product-for-buy__content">
                  ...
                  <img
                    src="./images/cart-page/product5.webp"
                    alt=""
                    className="same-product-for-buy__content-product-img"
                  />
                  <p className="same-product-for-buy__content-desc">
                    مایع لباسشویی پرسیل مدل گل وزن 2.7 کیلوگرم
                  </p>
                  <p className="fs-6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      viewBox="0 0 24 24"
                      style={{ width: "18px", height: "18px", fill: "#87d3e1" }}
                    >
                      <path
                        fillRule="evenodd"
      ...
      <div className="recent-visits">
        ...
        <div className="swiper recent-visits__swiper">
          <div className="swiper-wrapper recent-visits__swiper-wrapper">
            <div className="swiper-slide">
              <div className="recent-visits__wrapper">
                <a href="#" className="recent-visits__content">
                  <div className="recent-visits__content-amazing">
                    <img src="./images/cart-page/IncredibleOffer.svg" alt="" />
                  </div>
                  <img
                    src="./images/cart-page/recent-visits/product1.webp"
                    alt=""
                    className="recent-visits__content-product-img"
                  />
                  <p className="recent-visits__content-desc">
                    کاور مدل سیلیکونی محافظ لنزی مناسب برای گوشی موبایل اپل
                    IPhone 13
                  </p>
                  <p className="fs-6">
                    <svg
                  ...
                  <div className="recent-visits__content-price-box">
                    <p className="recent-visits__content-price-box-discount discount-percent">
                      ۶۰
                    </p>
                    <div className="recent-visits__content-price-box-prices">
                      <p className="recent-visits__content-price-box-prices-after-discount">
                        ۶۰,۰۰۰
                        <svg
                          id="toman"
                          xmlns="http://www.w3.org/2000/svg"
                      ...
                      <p className="recent-visits__content-price-box-prices-before-discount">
                        ۱۰۰,۰۰۰
                      </p>
                    </div>
                  </div>
                  <div className="recent-visits__content-finish">
                    <div className="recent-visits__content-finish-progress">
                      <div
                        className="recent-visits__content-finish-progress-bar"
                        style={{ width: "8.32292%" }}
                      ></div>
                    </div>
                    <div className="recent-visits__content-finish-sale">
                      <p className="recent-visits__content-finish-sale-text">
                        <span>۲۰%</span> فروش رفته
                      </p>
                      <p className="recent-visits__content-finish-sale-time timer">
                        ۲۲:۰۰:۰۹
                      </p>
                    </div>
                  </div>
            ...
            <div className="swiper-slide">
              <div className="recent-visits__wrapper">
                <a href="#" className="recent-visits__content">
                  ...
                  <img
                    src="./images/cart-page/recent-visits/product3.webp"
                    alt=""
                    className="recent-visits__content-product-img"
                  />
                  <p className="recent-visits__content-desc">
            ...
            <div className="swiper-slide">
              <div className="recent-visits__wrapper">
                <a href="#" className="recent-visits__content">
                  ...
                  <img
                    src="./images/cart-page/recent-visits/product2.webp"
                    alt=""
                    className="recent-visits__content-product-img"
                  />
                  <p className="recent-visits__content-desc">
                    آب زرشک و آب آلبالو و آب انار 125 - 1لیتر بسته 3 عددی
                  </p>
                  <p className="fs-6">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
          ...
          <div className="swiper-button-prev recent-visits__swiper-prev-btn"></div>
          <div className="swiper-button-next recent-visits__swiper-next-btn"></div>
        </div>
      </div>
    </div>
  );
