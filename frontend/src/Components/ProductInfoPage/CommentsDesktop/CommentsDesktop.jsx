...
export default function CommentsDesktop({commentRef,comments,setIsShowModalComment , isShowAllCommentsModal,setIsShowAllCommentsModal}) {
  return (
    <div className={`product-comments-desktop ${isShowAllCommentsModal ? 'show' : "" } ${comments.length ? '' : 'border-0'}`} id="commentsDesktop" ref={commentRef}>
